...
static void sha256_transform(SHA256_CTX *ctx, const unsigned char *message, unsigned int block_nb)
{
    uint32_t w[64];
    uint32_t wv[8];
    uint32_t t1, t2;
...
{
    ctx->m_h[0] = 0x6a09e667; ctx->m_h[1] = 0xbb67ae85; ctx->m_h[2] = 0x3c6ef372; ctx->m_h[3] = 0xa54ff53a;
    ctx->m_h[4] = 0x510e527f; ctx->m_h[5] = 0x9b05688c; ctx->m_h[6] = 0x1f83d9ab; ctx->m_h[7] = 0x5be0cd19;
    ctx->m_len = 0;
    ctx->m_tot_len = 0;
}
...
void sha256_final(SHA256_CTX *ctx, unsigned char *digest)
{
    ...
    memset(ctx->m_block + ctx->m_len, 0, pm_len - ctx->m_len);
